namespace SynergyGestion.Test.Dominio.Modelo.Inventario
{
    #region Using
    ...
    using SynergyGestion.Dominio.Modelo.Inventario;
    ...
    public class MovimientoStockTest
    {
        ...
        protected void SetUp()
        {
            ...
            this.stock1 = SynergyGestion.Dominio.Modelo.Inventario.DatosEjemplo.STOCK1_ART1;
            this.stock2 = SynergyGestion.Dominio.Modelo.Inventario.DatosEjemplo.STOCK2_ART1;
        }
